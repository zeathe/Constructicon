...
if 'VIRTUALENV_USE_DISTRIBUTE' not in os.environ:
    # ActivePython/PyPM has switched to Distribute
    # Fix virtualenv (distributed both by ActivePython and PyPM repositories)
    # to use Distribute by default.
    # To override this behaviour, the user must explicitly set the
    # `VIRTUALENV_USE_DISTRIBUTE' environment variable.
    os.environ['VIRTUALENV_USE_DISTRIBUTE'] = 'True'
